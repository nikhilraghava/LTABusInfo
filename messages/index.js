...
var connector = useEmulator ? new builder.ChatConnector() : new botbuilder_azure.BotServiceConnector({
    appId: process.env['f738381e-9b5e-4286-8762-877918cee32f'],
    appPassword: process.env['80SouSDUsE8Q1NnQyCpL67y'],
...
var ltaApiKey = "n3dXhZUZS3uknnIiGPy3IA=="
...
.matches('BusTiming.NextBus', (session, args) => {
    ...
    if (busStopNum){
        ...
        busStopNum = "75239" //Default fallback number
    }
